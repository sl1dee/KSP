import logo1 from "../../../assets/ksp-1920/images/LOGO 1.svg"
import logo2 from "../../../assets/ksp-1920/images/LOGO 2.svg"
    ...
    return (
        <div className={styles.footer}>
            <div className={styles.footer__columns}>
                ...
                <div className={styles.column}>
                    <div className={styles.upper__column1}>
                        <ul>
                            <li>
                ...
                <div className={styles.column}>
                    <div className={styles.upper__column2}>
                        <ul>
                            <li>
