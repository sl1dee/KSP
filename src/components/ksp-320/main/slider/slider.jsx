...
import chevronleft from "../../../../assets/ksp-320/icons/chevron-left.svg";
import othProduct1 from "../../../../assets/ksp-320/images/Rectangle 11.svg";
import ratestar from "../../../../assets/ksp-320/icons/Rate star.svg";
import othProduct2 from "../../../../assets/ksp-320/images/Rectangle 12.svg";
// import rating2 from "../../../../assets/ksp-320/icons/Rate2.svg";
import othProduct3 from "../../../../assets/ksp-320/images/Rectangle 13.svg";
import rating3 from "../../../../assets/ksp-320/icons/Rate3.svg";
import chevronright from "../../../../assets/ksp-320/icons/chevron-right.svg";
            ...
            <div className={styles.others__products__grid}>
                <div className={styles.product__cards}>
                    <div className={styles.product__cards__dop}>
                        ...
                        <div className={styles.rate}>
                            <img src={ratestar} alt="" className={styles.rate__stars}/>
                ...
                <div className={styles.product__cards}>
                    <div className={styles.product__cards__dop}>
                        ...
                        <div className={styles.product__cards__name}>Кронштейн фары противотуманной левой для Hyundai Sonata
                        </div>
                        <div className={styles.rate}>
                            <img src={ratestar} alt="" className={styles.rate__stars}/>
                            <div className={styles.rate__number}>4,4</div>
